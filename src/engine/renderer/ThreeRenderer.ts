...
export class ThreeRenderer {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    new BoardMesh(this._scene.scene, 12)
  ...
  // Starts the always-on render loop (coin spin, particles, camera fx)
  ...
  // Called by game loop each update tick
  public onSnakeUpdated(path: position[]) {
    this._snakeMesh.update(path)
  }
